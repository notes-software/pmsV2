                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="barcode" id="barcode" value="<?= $product['code'] ?>" autofocus>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="category" id="category" style="width: 100%;">
                                ...
                                foreach ($categories as $category) {
                                    $select = ($product['category'] == $category['id']) ? "selected" : "";
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="selling_price" id="selling_price" value="<?= $product['selling_price'] ?>" autofocus>
                        </div>
                    </div>
                </div>
            </div>
