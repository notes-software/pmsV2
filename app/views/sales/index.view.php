            ...
            <div style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;">
                ...
                <div class="card-tools">
                    <div class="align-left">
                        <a href="<?= route('/purchase/create') ?>" type="button" class="btn btn-default btn-sm">Add New Sales</a>
                        <button type="button" id="delete_unit_btn" class="btn btn-default btn-sm" onclick="deleteUnit()">Delete selected sales</button>
                    </div>
                </div>
            </div>
        </div>
