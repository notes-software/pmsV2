                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="employee_number" id="employee_number" autofocus>
                        </div>
                        <div class="form-group">
                            <label for="employee_contact">Contact #</label>
                            <input type="text" class="form-control" name="employee_contact" id="employee_contact" autofocus>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="employee_fullname">Fullname</label>
                            <input type="text" class="form-control" name="employee_fullname" id="employee_fullname" autofocus>
                        </div>
                        <div class="form-group">
                            <label for="employee_date_hired">Date Hired</label>
                            <input type="date" class="form-control" name="employee_date_hired" id="employee_date_hired" autofocus>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="employee_address">Address</label>
                            <input type="text" class="form-control" name="employee_address" id="employee_address" autofocus>
                        </div>
                        <div class="form-group">
